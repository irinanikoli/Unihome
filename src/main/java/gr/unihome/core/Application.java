...
public class Application {
    ...
    private static Criteria getUserCriteria(Scanner scanner, String universityName) {
        ...
        int budget = getValidIntInput(scanner, 250, 2500, "Το κόστος (ευρώ) πρέπει να είναι μεταξύ 250 και 2500: ");
        int size = getValidIntInput(scanner, 15, 150, "Τα τετραγωνικά μέτρα πρέπει να είναι μεταξύ 15 και 150: ");
        int maxDistanceFromUniversity = getValidIntInput(scanner, 30, 150000, "Η απόσταση από το Πανεπιστήμιο (μέτρα) πρέπει να είναι μεταξύ 30 και 150000: ");
        int maxDistanceFromMeans = getValidIntInput(scanner, 30, 150000, "Η απόσταση από ΜΜΜ (μέτρα) πρέπει να είναι μεταξύ 30 και 150000: ");
